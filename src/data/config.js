...
async function getConfig(env) {
  ...
  // Secret 绑定（wrangler secret put）在 env 上，合并进 config 供业务读取
  if (env.SMTP_BRIDGE_SECRET) config.SMTP_BRIDGE_SECRET = env.SMTP_BRIDGE_SECRET;
